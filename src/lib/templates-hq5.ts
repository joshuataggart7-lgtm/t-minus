...
const ppm: TemplateDef = {
  ...
  badge: {
    ...
    revision: "HQ 03/2025 revision",
    effective: "2025-03-01",
    note: "Used for non-competitive acquisitions and modifications above the simplified acquisition threshold; approved before negotiations begin. The price negotiation memorandum records the result.",
  },
  ...
  sections: [
    {
      ...
      tier: "binding",
      standingText:
        "The contracting officer (CO) has prepared this Prenegotiation Position Memorandum (PPM) pursuant to Federal Acquisition Regulation (FAR) 15.406 and NASA FAR Supplement (NFS) 1815.406.",
      fields: [
    ...
    },
    {
      ...
      citation: "FAR 5.201; FAR 44.3; NFS 1844.3; FAR 22.1103; FAR 19.702(a)(1); NFS 1845.201-70(a); FAR 15.404-4(c)(3)",
      tier: "binding",
      fields: [
        X("jofoc_status", "1. Justification for Other Than Full and Open Competition (JOFOC)", "jofoc_authority_citation"),
        D("jofoc_approved_on", "1. JOFOC approved on"),
        D("synopsis_date", "2. Synopsis posted to the Governmentwide point of entry (FAR 5.201) on"),
        X("interested_companies", "2. Number of interested companies"),
        S("accounting_system", "3(a). Accounting system is", CHECKBOX_SYSTEM),
        X("accounting_determined_by", "3(a). Determined by and on"),
        S("estimating_system", "3(b). Estimating system is", CHECKBOX_SYSTEM),
        X("estimating_determined_by", "3(b). Determined by and on"),
        S("purchasing_system", "3(c). Purchasing system (FAR 44.3; NFS 1844.3) is", ["", "Approved", "Approval Withheld", "Approval Withdrawn", "Other", "N/A"]),
        X("purchasing_determined_by", "3(c). Determined by and on"),
        S("tcp_received", "4. Total Compensation Plan received (FAR 22.1103)", ["", "Yes", "N/A"]),
        X("tcp_reviewed_by", "4. Reviewed by and on"),
        S("subcontracting_plan", "5. Small Business Subcontracting Plan received (FAR 19.702(a)(1))", ["", "Yes", "N/A"]),
        S("subcontracting_plan_position", "5. The Small Business Specialist", ["", "Concurred", "Non-concurred"]),
        S("consent_subcontractors", "6. Subcontractors require special surveillance consent and designation under FAR 52.244-2, paragraph (d)", ["", "Yes", "No", "N/A", "As yet undetermined"]),
        S("cas_disclosure", "7. Contractor's Cost Accounting Standards Disclosure Statement is", CHECKBOX_SYSTEM),
        S("ipo_review", "8. Industrial Property Officer review received (NFS 1845.201-70(a))", ["", "Yes", "N/A"]),
        S("ipo_position", "8. The Industrial Property Officer", ["", "Concurred", "Nonconcurred"]),
        S("fccm", "9. Contractor has proposed Facilities Capital Cost of Money (FCCM)", ["No", "Yes"]),
        S("cap_equipment", "10. Contractor has proposed Contractor-Acquired Property categorized as equipment charged directly to the contract", ["No", "Yes"]),
